        ...
        <div class="container py-lg-5 py-md-3">
            <div class="row">
                ...
                <div class="col-lg-6 mt-lg-0 mt-md-5 mt-4">
                    ...
                    <img src="<?php echo get_template_directory_uri().'/assets/images/s1.jpg'; ?>" alt="" class="img-fluid radius-image" />
...
<section class="w3l-homeblock3 py-5">
    <div class="container py-lg-5 py-md-4">
        <div class="row">
            <div class="col-lg-6 "><img src="<?php echo get_template_directory_uri().'/assets/images/s2.jpg'; ?>" alt="" class="img-fluid radius-image" />
            </div>
